data modify storage mm:main dialog.dialog set value {\
  ...
  "body": [\
    {\
      "type": "plain_message",\
      "contents": {\
        "translate": "mm.text_settings.map.spawn_waiting.description",\
        "color": "green"\
      }\
    }\
  ],\
  "actions": [\
    {\
      "label": {\
        "translate": "mm.text_settings.map.spawn_waiting.set",\
        "color": "yellow"\
      },\
      "action": {\
        "type": "run_command",\
        "command": "/function mm:settings/map/spawn_waiting/set/main"\
      }\
    }\
  ],\
  "exit_action": {\
...
data modify storage mm:main temporary.source_path set value "SpawnWaiting"
...
execute unless data storage mm:main temporary.pos run data modify storage mm:main dialog.dialog.body append value {\
  ...
  "type": "plain_message",\
  "contents": {\
    "translate": "mm.text_settings.map.spawn_waiting.value.add",\
    "color": "red"\
  }\
}
...
data modify storage mm:main dialog.dialog.body append value {\
  ...
  "type": "plain_message",\
  "contents": {\
    "translate": "mm.text_settings.map.spawn_waiting.value.current",\
    "color": "green",\
    "with": [\
      {\
        "text": "0",\
...
data modify storage mm:main dialog.dialog.actions append value {\
  "label": {\
    "translate": "mm.text_settings.map.spawn_waiting.teleport",\
    "color": "yellow"\
  },\
  "action": {\
    "type": "run_command",\
    "command": "/function mm:settings/map/spawn_waiting/teleport/main"\
  }\
}
...
data modify storage mm:main temporary.path set value "dialog.dialog.body[{tag:\"spawn_waiting\"}].contents.with[0].text"
...
data modify storage mm:main temporary.path set value "dialog.dialog.body[{tag:\"spawn_waiting\"}].contents.with[1].text"
data modify storage mm:main temporary.value set from storage mm:main temporary.pos[1] 
function mm:utils/set_string_data with storage mm:main temporary

data modify storage mm:main temporary.path set value "dialog.dialog.body[{tag:\"spawn_waiting\"}].contents.with[2].text"
data modify storage mm:main temporary.value set from storage mm:main temporary.pos[2] 
function mm:utils/set_string_data with storage mm:main temporary

data modify storage mm:main temporary.path set value "dialog.dialog.body[{tag:\"spawn_waiting\"}].contents.with[3].text"
