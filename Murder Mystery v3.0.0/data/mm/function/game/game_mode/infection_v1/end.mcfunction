...
execute if score survivor_left mm_data matches 0 run scoreboard players set @a[tag=mm_infected] mm_API_p 54

execute if score infected_left mm_data matches 0 run tellraw @a[tag=mm_playing] [{"text":"§e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e §e "},{"translate":"mm.text.winner","with":[{"translate":"mm.text.winner.survivor","color":"green"}]}]
execute if score infected_left mm_data matches 0 run scoreboard players set @a[tag=mm_infected] mm_API_p 56
execute if score infected_left mm_data matches 0 run scoreboard players set @a[tag=mm_survivor] mm_API_p 49
...
execute if score game_second mm_main matches 0 run scoreboard players set @a[tag=mm_infected] mm_API_p 56
...
execute if score infected_left mm_data matches 0 run scoreboard players add @a[tag=mm_survivor] mm_stats_1 1
...
tellraw @a[tag=mm_infected] ""

tellraw @a[tag=mm_infected] {"text":"=============================================","color":"green"}