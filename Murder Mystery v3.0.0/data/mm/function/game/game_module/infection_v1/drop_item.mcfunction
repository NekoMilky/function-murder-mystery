#刀
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{Knife:1}}}}] on origin run function mm:utils/give_or_replace/loot/main {count:1,item_tag:"Knife",slot:0,loot_table:"mm:knife"}
