...
execute at @s if score current_distance mm_main matches ..35 if block ~ ~ ~ #minecraft:air run function mm:game/game_module/map_features/torch/teleport_first with storage mm:main temporary
